...
else if (temperature >=25 &&  temperature < 35  && isRaining == true)
{
...
else if (temperature >=15 &&  temperature < 25  && isRaining == true)
{
  return "Cool and rainy - bring waterproof gear if hiking"
}
else if (temperature >=5 &&  temperature < 15  && isRaining == false)
{
  return  "Chilly - wear layers for your hike"
}
else if (temperature >=5 &&  temperature < 35  && isRaining == true)
{
